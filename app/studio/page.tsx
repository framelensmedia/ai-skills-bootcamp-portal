...
export default function StudioHubPage() {
    ...
    const quickTools = [
        { name: "Image", icon: ImageIcon, href: "/studio/creator", color: "text-amber-400 group-hover:text-amber-300" },
        { name: "Video", icon: Video, href: "/studio/creator?tab=video", color: "text-blue-400 group-hover:text-blue-300" },
        { name: "Motion Capture", icon: Activity, href: "/studio/creator?tab=animate", color: "text-purple-400 group-hover:text-purple-300" },
        { name: "Audio to Video", icon: AudioWaveform, href: "/studio/creator?tab=audio2video", color: "text-rose-400 group-hover:text-rose-300" },
        { name: "Music", icon: Music, href: "/studio/creator?tab=music", color: "text-emerald-400 group-hover:text-emerald-300" },
