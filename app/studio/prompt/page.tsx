    ...
    <main className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6 sm:py-10 text-white">
      ...
      <section className="grid grid-cols-1 gap-6 lg:grid-cols-2" ref={previewRef}>
        ...
        <div className="order-2 lg:order-1 p-0 sm:p-2 space-y-4">
          ...
          <div className="relative rounded-xl border border-white/10 bg-[#111] p-6 backdrop-blur-2xl shadow-2xl ring-1 ring-white/5 overflow-hidden">
          ...
          {/* Generator Settings */}
          <div className="rounded-xl border border-white/10 bg-[#111] p-6 backdrop-blur-2xl shadow-2xl ring-1 ring-white/5">
          ...
          <div className="space-y-4 pt-4 border-t border-white/5">
            ...
            {videoResult ? (
              ...
              <button
                ...
                className={[
                  "w-full inline-flex items-center justify-center rounded-2xl px-8 py-5 text-base font-bold tracking-tight text-white transition-all transform hover:scale-[1.01] shadow-[0_0_20px_-5px_rgba(183,255,0,0.3)]",
              ...
              <button
                ...
                className={[
                  "w-full inline-flex items-center justify-center rounded-2xl px-8 py-5 text-base font-bold tracking-tight text-black transition-all transform hover:scale-[1.01] shadow-[0_0_20px_-5px_rgba(183,255,0,0.3)]",
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className="inline-flex items-center justify-center rounded-2xl border border-white/10 bg-[#111] px-4 py-3 text-sm font-bold tracking-tight text-white/60 hover:text-white hover:bg-white/10 transition-all"
              >
        ...
        < div className="order-1 lg:order-2 space-y-4" >
          ...
          <div className="flex flex-wrap items-center justify-center gap-2">
            <span className="rounded-full border border-white/10 bg-[#111] px-4 py-1.5 text-xs font-semibold tracking-wide text-white/50 backdrop-blur-md">
