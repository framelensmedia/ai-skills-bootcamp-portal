...
import CharacterTab from "../creator/_components/CharacterTab";
            ...
            <div className="mb-8 flex flex-col md:flex-row gap-4 md:items-end md:justify-between border-b border-white/10 pb-6">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3 mb-1">
                        <UserCircle2 className="w-8 h-8 text-lime-400" />
                        Character Studio
                    </h1>
                    <p className="text-sm text-white/50">
                        Build a consistent character reference sheet from your photos
                    </p>
                </div>
                {userCredits !== null && (
