        ...
        <div className="flex flex-col min-h-[80vh] items-center py-12 px-4 my-auto">
            <div className="text-center max-w-3xl mb-16">
                ...
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl md:px-8 mx-auto">
                    Stop paying expensive agencies or spending hours struggling with complicated design tools. Here is how easy it is to grow your business with&nbsp;AI Skills Studio.
                </p>
            </div>
