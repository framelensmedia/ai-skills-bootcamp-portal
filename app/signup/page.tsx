        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
          ...
          <div className="mt-6 space-y-4">
            <button
              ...
              disabled={loading}
              className="flex w-full items-center justify-center gap-2 rounded-lg border border-white/10 bg-white py-2.5 text-sm font-semibold text-black hover:bg-white/90 disabled:opacity-60"
            >
